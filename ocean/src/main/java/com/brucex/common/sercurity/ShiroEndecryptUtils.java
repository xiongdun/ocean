...
/**
 * @description shiro 密码加密解密工具类
 * @author xiongdun
 * @datetime 2017年5月16日下午8:55:04
 */
public class ShiroEndecryptUtils {

	/**
	 * @description base64进制加密
	 * @author xiongdun
	 * @datetime 2017年5月16日下午9:03:21
	 * @param password
	 * @return
	 */
	...
	/**
	 * @description base64进制解密
	 * @author xiongdun
	 * @datetime 2017年5月16日下午9:03:13
	 * @param cipherText
	 * @return
	 */
	...
	/**
	 * @description 对密码进行md5加密,并返回密文和salt，包含在User对象中
	 * @author xiongdun
	 * @datetime 2017年5月16日下午9:02:53
	 * @param username
	 * @param password
	 * @return
	 */
	public static User md5Password(String username, String password) {
		...
		String password_cipherText = new Md5Hash(password, username + salt, 6).toHex();
		User user = new User();
	...
	/**
	 * @description 通过username,password,salt,校验密文是否匹配 ，校验规则其实在配置文件中，这里为了清晰，写下来
	 * @author xiongdun
	 * @datetime 2017年5月16日下午9:02:14
	 * @param username
	 * @param password
	 * @param salt 盐
	 * @param md5cipherText 密文,从数据库中查询得到
	 * @return
	 */
